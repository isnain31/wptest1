...
function cleanblog_widgets()
{
	...
	register_sidebar(array(
        'name' => __('Shop Sidebar', 'cleanblogg'),
        'id' => 'cb-woo-sidebar',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
        'before_title' => '<h4 class="widget-title">',
...
class cleanblogg_Social_Widget extends WP_Widget {
	...
	public function form( $instance ) {    
     $defaults = array( 'cleanblogg_social_title' => 'Follow Us','cleanblogg_socialw_rss' => false);
        ...
        <p><strong><?php _e('Note:','cleanblogg')?></strong> <?php _e('Set your social links in the','cleanblogg')?> <br /><?php _e('Appearance &#187; Customize &#187; Social Links','cleanblogg')?></p>
    <?php 
    }   
}
    ...
    public function __construct() {
        parent::__construct(
            ...
            array(
                ...
                'description' => __( 'A widget that displays recent posts & popular posts as tabs', 'cleanblogg' )
                )
        );
    }
	public function widget( $args, $instance ) {    
