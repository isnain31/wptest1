...
<html <?php language_attributes(); ?> xmlns="http://www.w3.org/1999/xhtml">
	...
	$cleanblog_header_cart_icon = get_theme_mod( 'cleanblog_header_cart_icon', 'hide');
      ...
      <?php get_template_part('inc/header/layout-'.$cleanblog_header_style); ?>
		...
		<?php if (get_theme_mod( 'cleanblog_slider_show')!= "hide" ): ?>
      	<?php
			...
			?>
              <section class="cb-carousal-slider cb-main-slider <?php echo $slider_type.' '.$slider_date_class; ?>">
                                  ...
                                  <div class="item">
                                      <div class="cb-slider-block" <?php if (has_post_thumbnail()) :?> style="background-image:url('<?php echo $post_image_url[0]; ?>');" <?php endif; ?>>
                                          <div class="cb-slider-inner">
                                              ...
                                              <a href="<?php the_permalink(); ?>" class="cb-more"><?php echo __( 'Read More','cleanblog-pro' ); ?></a>
                                          </div>
                                      </div>
                                  </div>
                            <?php endwhile; ?>
			...
			?>
              <section class="cb-carousal-slider cb-main-slider <?php echo $slider_date_class; ?>">
                  <div class="container-fluid">
                     <div class="owl-carousel cb-carousel owl-theme">
            <?php while ( $the_query->have_posts() ) : $the_query->the_post(); 
                                    $image_id = get_post_thumbnail_id();
                                    $post_image_url = wp_get_attachment_image_src($image_id,'cleanblogg-grid-thumb', true); ?>
                                  <div class="item">
                                      <div class="cb-slider-block" <?php if (has_post_thumbnail()) :?> style="background-image:url('<?php echo $post_image_url[0]; ?>');"<?php endif; ?>>
                                          <div class="cb-slider-inner">
                                              <h2><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
           ...
           elseif ($slider_type === 'metro'):
			?>
              <section class="cb-metro-slider cb-main-slider <?php echo $slider_date_class; ?> ">
                  <div class="container-fluid">
                     <ul>
            		<?php
					$i = 0; 
            ...
            <?php else: ?>
              <section class="cb-slider cb-main-slider <?php echo $slider_date_class; ?>">
                  <div class="container-fluid">
                    <ul>
					<?php while ( $the_query->have_posts() ) : $the_query->the_post(); 
							$image_id = get_post_thumbnail_id();
                          ...
                          <li>
                              <div class="cb-slider-block" <?php if (has_post_thumbnail()) :?> style="background-image:url('<?php echo $post_image_url[0]; ?>');" <?php endif; ?>>
                                  <div class="cb-slider-inner">
                                      <h2><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
                                      <span class="cb-slider-date"><?php echo get_the_date(); ?></span>
                                      <a href="<?php the_permalink(); ?>" class="cb-more"><?php echo $cleanblog_read_more_text; ?></a>
                                  </div>
                              </div>
                            </li>
					<?php endwhile; ?>
